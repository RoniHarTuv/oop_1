    ...
    public boolean isPawnEaten(ConcretePiece p1, ConcretePiece p2) {
        ...
        if (_isPlayer2Turn && p2.getType().equals("♙")) {
            if (y1 > 0 && _MAP[x1][y1 - 1] == p2 && x1 != y2 - 1 && u1.equals("♙") && (u2.equals("♟") || u2.equals("w") || u2.equals("c"))) {
                p1.set_n("n", d1, r1, l1);
                if(u2.equals("♟")){
                    _MAP[x1][y2-1].set_n(_MAP[x1][y2-1].get_n()[0],"n",_MAP[x1][y2-1].get_n()[2],_MAP[x1][y2-1].get_n()[3]);
                }
            ...
            if (y1 < 10 && _MAP[x1][y1 + 1] == p2 && y1 != y2 + 1 && d1.equals("♙") && (d2.equals("♟") || d2.equals("w") || d2.equals("c"))) {
                p1.set_n(u1, "n", r1, l1);
                if(d2.equals("♟")){
                    _MAP[x1][y2+1].set_n("n",_MAP[x1][y2+1].get_n()[1],_MAP[x1][y2+1].get_n()[2],_MAP[x1][y2+1].get_n()[3]);
                }
                _MAP[p2._position._x][p2._position._y].setTurnWasEaten(numberOfTurn);
                _stackForEatenUndo.push(_MAP[p2._position._x][p2._position._y]);
                //   _piecesWasEaten1.add(p2);
            ...
            if (x1 < 10 && _MAP[x1 + 1][y1] == p2 && x1 != x2 + 1 && r1.equals("♙") && (r2.equals("♟") || r2.equals("w") || r2.equals("c"))) {
                p1.set_n(u1, d1, "n", l1);
                if(r2.equals("♟")){
                    _MAP[x2+1][y1].set_n(_MAP[x2+1][y1].get_n()[0],_MAP[x2+1][y1].get_n()[1],_MAP[x2+1][y1].get_n()[2],"n");
                }
                _MAP[p2._position._x][p2._position._y].setTurnWasEaten(numberOfTurn);
                _stackForEatenUndo.push(_MAP[p2._position._x][p2._position._y]);
                //  _piecesWasEaten1.add(p2);
            ...
            if (x1 > 0 && _MAP[x1 - 1][y1] == p2 && x1 != x2 - 1 && l1.equals("♙") && (l2.equals("♟") || l2.equals("w") || l2.equals("c"))) {
                p1.set_n(u1, d1, r1, "n");
                if(l2.equals("♟")){
                    _MAP[x2-1][y2].set_n(_MAP[x2-1][y2].get_n()[0],_MAP[x2-1][y2].get_n()[1],"n",_MAP[x2-1][y2].get_n()[3]);
                }
                _MAP[p2._position._x][p2._position._y].setTurnWasEaten(numberOfTurn);
                _stackForEatenUndo.push(_MAP[p2._position._x][p2._position._y]);
                //  _piecesWasEaten1.add(p2);
        ...
        if (!_isPlayer2Turn && p2.getType().equals("♟")) {
            ...
            if (x1 < 10 && _MAP[x1 + 1][y1] == p2 && x1 != x2 + 1 && r1.equals("♟") && (r2.equals("♙") || r2.equals("w") || r2.equals("c"))) {
                p1.set_n(u1, d1, "n", l1);
                if(r2.equals("♙")){
                    _MAP[x2+1][y1].set_n(_MAP[x2+1][y2].get_n()[0],_MAP[x2+1][y2].get_n()[1],_MAP[x2+1][y2].get_n()[2],"n");
                }
                _MAP[p2._position._x][p2._position._y].setTurnWasEaten(numberOfTurn);
                //   _piecesWasEaten2.add(p2);
                _stackForEatenUndo.push(_MAP[p2._position._x][p2._position._y]);
